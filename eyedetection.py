...
# Initialize variables for blink counting
blink_count = 0
total_blinks = 0
previous_state = 0
...
# Initialize variables for EAR calculation
EYE_AR_THRESH = 0.3
...
while True:
    ...
    for face in faces:
        ...
        # Check for a blink (EAR below the threshold)
        ...
        # Draw the blink count on the frame
